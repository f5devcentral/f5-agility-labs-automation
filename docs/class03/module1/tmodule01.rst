...
#. Click on the ``Components`` tab in your UDF deployment
    .. image:: /_static/as3/components.jpg
...
#. Enter credentials: user / user
    .. image:: /_static/as3/Win2019_RDP_DiffAccount.JPG

#. Click ``OK``.
    .. image:: /_static/as3/Win2019_RDP_Login.JPG

#. When prompted, click ``Yes`` to connection, and session will be established to Windows host.
    .. image:: /_static/as3/Win2019_RDP_YesConnect.JPG
...
#. First, import the Postman collection, which are located on a github repository. On the top left, click the ``Import`` button.
    ...
    .. image:: /_static/as3/import.jpg

#. Select ``Import From Link`` and paste the link into the text box, ``https://raw.githubusercontent.com/f5devcentral/f5-agility-labs-automation/master/docs/_static/as3/AS3%202020%20Lab.postman_collection20200204.json``, then click ``Import``:

    .. image:: /_static/as3/import_from_link.jpg
