...
F5 BIG-IP <../1.2-add-node/README.html>`__.
...
1.3 - Adding a load balancing pool <../1.3-add-pool/README.html>`__.
...
pool <../1.4-add-pool-members/README.html>`__.
...
server <../1.5-add-virtual-server/README.html>`__.
...
will be identical to `Exercise 1.6 - Deleting F5 BIG-IP
Configuration <../1.6-delete-configuration/1.6-delete-configuration>`__. The
